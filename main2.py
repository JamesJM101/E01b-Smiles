...
arcade.draw_ellipse_filled(face_x + 20, face_y + 30, 15, 25, open_color.black)
arcade.draw_ellipse_filled(face_x + -20, face_y + 30, 15, 25, open_color.black)
arcade.draw_circle_filled(face_x + 23, face_y + 33, 3, open_color.gray_2)
arcade.draw_circle_filled(face_x + -17, face_y + 33, 3, open_color.gray_2)
